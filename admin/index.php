...
<head>
	...
	<style>
	body { 
		background:url(../bg.png) no-repeat top;background-attachment:fixed;background-size: cover;
			...
			<div class="layui-tab-content">
				<div class="layui-tab-item layui-show" name="基本设置">
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<input type="checkbox" name="yzm[danmuon]" lay-skin="switch" lay-filter="switchTest" lay-text="ON|OFF" <?php $t = empty($yzm['danmuon'])?'off':$yzm['danmuon'];
																																	if ($t == "on") {
																																		echo "checked";
																																	} ?>>
					...
					<div class="layui-form-item">
						...
						<div class="layui-form-mid layui-word-aux">图片地址 例如：https://qkongtao.cn/wp-content/uploads/2020/12/d11-e1628358435552.png</div>
					</div>
					<div class="layui-form-item">
				...
				<div class="layui-tab-item" name="广告设置">
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<input type="checkbox" name="yzm[ads][state]" lay-skin="switch" lay-filter="switchTest" lay-text="ON|OFF" <?php $t = empty($yzm['ads']['state'])?'off':$yzm['ads']['state'];
																																		if ($t == "on") {
																																			echo "checked";
																																		} ?>>
							<div class="layui-unselect layui-form-switch" lay-skin="_switch"><em>Off</em><i></i></div>
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<input type="checkbox" name="yzm[ads][pause][state]" lay-skin="switch" lay-filter="switchTest" lay-text="ON|OFF" <?php $t = empty($yzm['ads']['pause']['state'])?'off':$yzm['ads']['pause']['state'];
																																				if ($t == "on") {
																																					echo "checked";
																																				} ?>>
							<div class="layui-unselect layui-form-switch" lay-skin="_switch"><em>Off</em><i></i></div>
